      ...
      <div className="h-screen w-full bg-gradient-to-b from-blue-950 to-black text-white overflow-y-scroll snap-y snap-mandatory relative mx-auto hide-scrollbar">
        ...
        <div className="fixed top-4 left-4 z-50">
          <button
            ...
            className="text-2xl font-bold text-white hover:text-white/90 transition-all flex items-center gap-2 px-4 py-2 rounded-full bg-black/40 backdrop-blur-md border border-white/20 shadow-lg"
          >
            NerdTok
          </button>
        </div>
        ...
        <div className="fixed top-4 right-4 z-50 md:hidden">
          <button
            ...
            className="p-2 rounded-full bg-black/40 backdrop-blur-md hover:bg-white/20 transition-all border border-white/20 shadow-lg"
          >
        ...
        <div className="fixed top-4 left-1/2 transform -translate-x-1/2 z-50 hidden md:flex gap-2 bg-black/40 backdrop-blur-md p-1 rounded-full border border-white/20 shadow-lg">
          <button
        ...
        <div className="fixed top-4 right-4 z-50 hidden md:flex gap-2 bg-black/40 backdrop-blur-md p-1 rounded-full border border-white/20 shadow-lg">
          <button
        ...
        {showMobileMenu && (
          <div className="fixed inset-x-4 top-16 z-50 md:hidden">
            <div className="bg-gray-900/80 backdrop-blur-md rounded-lg border border-white/20 shadow-xl p-2 space-y-2 modal-animation">
              <button
                onClick={() => {
              ...
              <button
                ...
                className="w-full px-4 py-2 rounded-lg text-white hover:bg-white/20 transition-all text-left"
              >
                About
              </button>
              <button
