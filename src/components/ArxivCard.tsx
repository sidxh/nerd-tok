    ...
    return (
        <div className="h-screen w-full flex items-center justify-center snap-start relative">
            <div className="h-full w-full relative">
                ...
                {/* Content container */}
                <div className="absolute inset-0 p-6 flex flex-col justify-center text-white z-10 overflow-y-auto">
                    <div className="flex justify-between items-start mb-4">
                        <div className="flex-1">
                            <h2 className="text-2xl font-bold drop-shadow-lg mb-3">{paper.title}</h2>
                        ...
                        <div className="flex gap-3 ml-4">
                            ...
                            >
                                <Heart className={`w-5 h-5 ${isLiked(paper.id) ? 'fill-white' : ''}`} />
                            </button>
                            <button
                                onClick={handleShare}
                                className="p-3 rounded-full bg-white/10 backdrop-blur-sm hover:bg-white/20 transition-all transform hover:scale-110"
                    ...
                    <p className="text-gray-100 mb-6 drop-shadow-lg line-clamp-6 leading-relaxed">
                        {paper.abstract}
                    </p>
                    ...
                    <div className="flex items-center gap-4">
                        <a
                            ...
                            className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 px-5 py-2.5 rounded-lg transition-all transform hover:scale-105"
                        >
